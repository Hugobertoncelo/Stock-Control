  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer:
        'Navegue até a página de Produtos e clique no botão "Adicionar Produto". Preencha os campos obrigatórios, incluindo nome do produto, SKU, preços e níveis de quantidade. Selecione uma loja e um fornecedor, e clique em Salvar. O produto estará imediatamente disponível em seu inventário.',
    },
    {
      category: "Começando",
    ...
    {
      category: "Gerenciamento de Inventário",
      question: "Como faço para rastrear o estoque em várias lojas?",
      answer:
        "Cada produto pode ser atribuído a uma loja específica. Ao visualizar a página de Produtos, você pode filtrar por loja para ver os níveis de estoque de cada local. O sistema rastreia o inventário separadamente para cada loja e fornece contagens de estoque em tempo real.",
    },
    {
      category: "Gerenciamento de Inventário",
      question:
